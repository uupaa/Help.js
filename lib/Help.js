...
function Help(object) { // @arg Function/String: target object or string
    ...
    if (typeof object === "function") {
        return global.process ? console.log(_quickHelp(object))
                              : _quickHelp(object);
    }
    if (typeof object === "string") {
        ...
        return global.process ? console.log(_quickHelp(targetObject, longName))
                              : _quickHelp(targetObject, longName);
    }
...
function _quickHelp(object,     // @arg this:
    ...
    if (match && match[1]) { // @help is not empty
        ...
        url.push( "Google:\n    " + _createGoogleSearchURL(fullName) );
        url.push( "MDN:\n    " + _createGoogleImFeelingLuckyURL(fullName, "MDN") );
    }
    return "\n" + object + "\n\n" + url.join("\n");
}
