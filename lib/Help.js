...
Help["magic"] = Help_magic; // 

_extendGetter(Function["prototype"], "help", function() {
    return Help( _getFunctionPath(this) );
});

// --- implement -------------------------------------------
function Help_magic(target) { // @arg Function/String
                              // @arg String:
    var path = ""; // "Object.freeze"
    var fn = null; // Object.freeze

    if (typeof target === "function") {
        path = _getFunctionPath(target);
        fn = target;
...
function _getFunctionPath(fn) { // @arg Function: Object.freeze
                                // @ret String: "Object.freeze"
    var path = "";

    try {
        Object.getOwnPropertyNames(global).some(function(className) {
            if (1) {
                if (typeof global[className] === "function") {
                    ...
                    var result = Object.getOwnPropertyNames(global[className]).some(function(staticMember) {
                    ...
                    if ("prototype" in global[className]) {
                        return Object.getOwnPropertyNames(global[className]["prototype"]).some(function(method) {
                                try {
                                    ...
                                    // maybe: touch Uint16Array.prototype.buffer
